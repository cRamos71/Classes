...
public class BST_AED2_2022<Key extends Comparable<Key>, Value> {
  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    //print2d() via https://www.geeksforgeeks.org/print-binary-tree-2-dimensions/
    ...
    /* This function traverse the binary tree and
       stores its nodes in nodes[] */
    ...
    public int keyCount(){
        return keyCount(root);
    }

    private int keyCount(Node x){
        if(x == null)
            return 0;
        return keyCount(x.left) + keyCount(x.right) + 1;
    }
    ...
    public static void main(String[] args) {
        ...
        BST_AED2_2022<String, Integer> st = new BST_AED2_2022<String, Integer>();
